execute if entity @s[tag=skin_14_1] run return run function raurus:skins/rolls/roll

tellraw @s {"text":"> You have received a skin for Arid Phantom: [Knight of the Desert]!","color":"aqua"}

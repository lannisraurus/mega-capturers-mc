execute if entity @s[tag=skin_2_2] run return run function raurus:skins/rolls/roll

tellraw @s {"text":"> You have received a skin for Shadowfallen Assassin: [Undercover Pig]!","color":"aqua"}

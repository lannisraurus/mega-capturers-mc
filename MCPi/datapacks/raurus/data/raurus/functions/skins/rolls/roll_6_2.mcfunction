execute if entity @s[tag=skin_6_2] run return run function raurus:skins/rolls/roll

tellraw @s {"text":"> You have received a skin for Goldplated Guardian: [Stone Statue]!","color":"aqua"}

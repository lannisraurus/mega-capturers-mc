execute if entity @s[tag=skin_1_1] run return run function raurus:skins/rolls/roll

tellraw @s {"text":"> You have received a skin for Bluegem Sorcerer: [Light Blue Trim]!","color":"aqua"}

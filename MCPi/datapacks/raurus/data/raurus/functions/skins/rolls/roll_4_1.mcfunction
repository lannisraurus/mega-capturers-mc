execute if entity @s[tag=skin_4_1] run return run function raurus:skins/rolls/roll

tellraw @s {"text":"> You have received a skin for Biomechanical Machine: [Legacy Skin]!","color":"aqua"}

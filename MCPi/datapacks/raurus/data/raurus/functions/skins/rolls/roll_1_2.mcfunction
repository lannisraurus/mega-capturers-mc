execute if entity @s[tag=skin_1_2] run return run function raurus:skins/rolls/roll

tellraw @s {"text":"> You have received a skin for Bluegem Sorcerer: [Undercover Slime]!","color":"aqua"}

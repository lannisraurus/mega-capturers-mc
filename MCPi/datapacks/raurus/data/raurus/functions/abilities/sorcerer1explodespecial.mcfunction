execute as @s[tag=red] run damage @e[limit=1,sort=nearest,team=blue] 4 minecraft:magic
execute as @s[tag=blue] run damage @e[limit=1,sort=nearest,team=red] 4 minecraft:magic
